...
{
    public partial class UserEntryUI : System.Web.UI.Page
    {
        ...
        private void LoadUserTypes()
        {
            try
            {
                DataTable dataTable = ABS_IDB.GetDataByProc("sm_getUserType");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    VmStudentRegistration _objUser = new VmStudentRegistration();
                    ...
                    long status = UserEntryBLL.InsertUser(_objUser);
                    if (status > 0)
                    {
