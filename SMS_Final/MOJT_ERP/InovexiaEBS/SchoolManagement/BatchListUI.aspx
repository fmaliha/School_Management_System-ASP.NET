                            ...
                            <ItemStyle Width="70px"></ItemStyle>
                              ...
                              <asp:TemplateField HeaderText="Actions" ItemStyle-Width="40" >
                                    <ItemTemplate >
                                        ...
                                        <%-- <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-danger pull-right" CommandArgument= '<%# Eval("BatchID") %>' OnClick="Btn_GetBatchwiseSub">Edit</asp:LinkButton>--%>
