                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <telerik:RadComboBox ID="ddlSelectSubject"  runat="server" DropDownCssClass="widthClass"  
                                        EmptyMessage="Select Subject" EnableLoadOnDemand="True" Filter="Contains" Height="200px" 
                                        HighlightTemplatedItems="True" Width="100%" Skin="Silk" Style="background-color: #339966;" 
                                        AutoPostBack="False" OnItemsRequested="ddlSelectSubject_ItemsRequested" >
                                        <HeaderTemplate>
