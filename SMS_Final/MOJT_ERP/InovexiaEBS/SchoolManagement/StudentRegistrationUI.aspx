<%@ Page Title="" Language="C#" MasterPageFile="~/InvexiaMaster.Master" AutoEventWireup="true" CodeBehind="StudentRegistrationUI.aspx.cs" Inherits="InovexiaEBS.SchoolManagement.StudentRegistrationUI" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <%-- <div id="messages" class="notify notify-messages">
    ...
    <div class="alert alert-dark" id="alertstuD1" runat="server" role="alert">
                <h5 style="color: whitesmoke; font-family: cursive">Student Details Saved Successfully!</h5>
              </div>  
                                                ...
                                                <h2 style="font-family: monospace">Enrolment</h2>
                                                     <br/>
                                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                            ...
                                                            <li class="nav-item" id="tabG" runat="server" >
                                                                <a  class="nav-link disabled" id="tabGuardianDetails" runat="server" href="#GuardianDetails" data-toggle="tab" role="tab"
                                                                     aria-controls="GuardianDetails"
                                                                     aria-selected="False"><b>Guardian Details</b></a>
                                                            </li>

                                                            <li  class="nav-item" >
                                                                <a  class="nav-link disabled" id="tabEmergencyContact" runat="server"  href="#EmergencyContact"  data-toggle="tab" role="tab" 
                                                                    aria-controls="EmergencyContact"
                                                                    aria-selected="False"><b>Emergency Contact</b></a>
                                                            </li>
                                                            
                                                            <li class="nav-item" >
                                                                <a   class="nav-link disabled" id="tabPreviousDetails" runat="server"  href="#PreviousDetails"  data-toggle="tab" role="tab"
                                                                     aria-controls="PreviousDetails"
                                                                     aria-selected="False"><b>Previous Details</b></a>
                                                            </li>
                                                             <li class="nav-item" >
                                                                 <a  class="nav-link disabled" id="tabStudentDocuments" runat="server"  href="#StudentDocuments"  data-toggle="tab" role="tab"
                                                                      aria-controls="StudentDocuments"
                                                                     aria-selected="False" ><b>Student Documents</b></a>
                                                            </li>

                                                              <li class="nav-item">
                                                                <a aria-controls="additionaldetails" aria-selected="False" class="nav-link disabled" data-toggle="tab" href="#additionaldetails" id="tabadditionaldetais" role="tab" runat="server"><b>Additional Details</b></a>
                                                            </li>
      ...
      <br /><br />
                                           ...
                                           <div class="row " id="divpdetails" runat="server" >
                                                                    ...
                                                                    <br/>
                                                                        ...
                                                                        <div class="col-md-4" >
                                                                                ...
                                                                                <br/>
                                                                                <asp:TextBox ID="txtmdln" runat="server" CssClass="form-control"></asp:TextBox>
                                                                            <br/>
                                                                            <br/>
                                     ...
                                     <div class="col-lg-12">
                                         <div class="card">
                                             <div class="card-body divColorb">
                                                 ...
                                                 <div class="list-divider"></div>
                                                    <br/>
                                              <%--   <telerik:RadAsyncUpload ID="upstuphoto" runat="server" ></telerik:RadAsyncUpload>
                                                 <cc1:AsyncFileUpload ID="" runat ="" ></cc1:AsyncFileUpload> --%>
                                                        ...
                                                        <div class="col-md-4">
                                                              <asp:Label ID="Label64" runat="server" Text="Nationality"  Font-Bold="true"></asp:Label>
                                                                ...
                                                                <telerik:RadComboBox ID="ddlNationalityE"  runat="server" DropDownCssClass="widthClass"  
                                                                                     OnItemsRequested="ddlnationalityE_ItemsRequested"
                                                                                     EmptyMessage="Select Nationality" EnableLoadOnDemand="True" Filter="Contains" Height="200px"
                                                                                      HighlightTemplatedItems="True" Width="100%" Skin="Silk" Style="background-color: #339966;"
                                                                                      AutoPostBack="False" SetFocusOnError="True">
                                                        ...
                                                        <div class="col-md-4">
                                                              <asp:Label ID="Label98" runat="server" Text="Nationality"  Font-Bold="true"></asp:Label>
                                                                ...
                                                                <telerik:RadComboBox ID="ddlNationalityR1"  runat="server" DropDownCssClass="widthClass"  
                                                                                     OnItemsRequested="ddlnationalityR1_ItemsRequested"
                                                                                     EmptyMessage="Select Nationality" EnableLoadOnDemand="True" Filter="Contains" Height="200px"
                                                                                      HighlightTemplatedItems="True" Width="100%" Skin="Silk" Style="background-color: #339966;"
                                                                                      AutoPostBack="False" SetFocusOnError="True">
                                                        ...
                                                        <div class="col-md-4">
                                                              <asp:Label ID="Label106" runat="server" Text="Nationality"  Font-Bold="true"></asp:Label>
                                                                ...
                                                                <telerik:RadComboBox ID="ddlNationalityR2"  runat="server" DropDownCssClass="widthClass"  
                                                                                     OnItemsRequested="ddlnationalityR2_ItemsRequested"
                                                                                     EmptyMessage="Select Nationality" EnableLoadOnDemand="True" Filter="Contains" Height="200px"
                                                                                      HighlightTemplatedItems="True" Width="100%" Skin="Silk" Style="background-color: #339966;"
                                                                                      AutoPostBack="False" SetFocusOnError="True">
                                                         ...
                                                         <div class="col-md-4">
                                                          ...
                                                          <div class="col-md-4">
                                                                    <asp:Label ID="Label33" runat="server" Text="Gender"  Font-Bold="true"></asp:Label>  &nbsp;&nbsp;&nbsp;
                                                                                  <telerik:RadComboBox ID="ddlgenderS"  runat="server" DropDownCssClass="widthClass" SetFocusOnError="True"
                                                                                   EmptyMessage="Select Gender" EnableLoadOnDemand="True" Filter="Contains" Height="200px" HighlightTemplatedItems="True"
                                                                                   Width="100%" Skin="Silk" Style="background-color: #339966;" AutoPostBack="False" AppendDataBoundItems="True"
                                                                                  OnItemsRequested="ddlgenderS_ItemsRequested" >
                                                         ...
                                                         <div class="col-md-4">
                                                          ...
                                                          <div class="col-md-4">
                                                                    <asp:Label ID="lblsgender2" runat="server" Text="Gender"  Font-Bold="true"></asp:Label>  &nbsp;&nbsp;&nbsp;
                                                                     <telerik:RadComboBox ID="ddlSgender"  runat="server" DropDownCssClass="widthClass" SetFocusOnError="True"
                                                                                   EmptyMessage="Select Gender" EnableLoadOnDemand="True" Filter="Contains" Height="200px" HighlightTemplatedItems="True"
                                                                                   Width="100%" Skin="Silk" Style="background-color: #339966;" AutoPostBack="False" AppendDataBoundItems="True"
       ...
       <Triggers>
               <asp:PostBackTrigger ControlID="btnsavestu" />  <%-- //works fine--%>
               <asp:PostBackTrigger ControlID="btnsavedoc"/>
               
               <%--<asp:AsyncPostBackTrigger ControlID = "btnsavestu"/>--%>  <%--//returns null value if used--%>
            </Triggers>
