...
function LoadPOPDropDownCustom(methodUrl, ddl) {
...
function LoadZone(methodUrl, ddl) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.resultList, function (key, value) {
                $("#" + ddl).append($("<option></option>").val(value.Id).html(value.ZoneName));
            });
...
function LoadStatusDropDownCustom(methodUrl, ddl) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data.resultList, function (key, value) {
                $("#" + ddl).append($("<option></option>").val(value.StatusId).html(value.StatusName));
            });
...
function LoadProfileDropDown(methodUrl, ddl) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.d, function (key, value) {
                $("#" + ddl).append($("<option></option>").val(value.ProfileId).html(value.ProfileName));
            });
...
function LoadPackageDropDown(methodUrl, ddl) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.d, function (key, value) {
                $("#" + ddl).append($("<option></option>").val(value.PackageId).html(value.PackageName));
            });
...
function LoadZoneDropDown(methodUrl, ddl, popId) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.d, function (key, value) {
                $("#" + ddl).append($("<option></option>").val(value.ZoneId).html(value.ZoneName));
            });
...
function LoadDesignationDropDown(methodUrl, ddl) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.d, function (key, value) {
                $("#" + ddl).append($("<option></option>").val(value.ProfileName).html(value.Description));
            });
