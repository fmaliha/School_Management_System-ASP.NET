...
{
    public partial class ProgramSpecialization : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_ItemUpdated(object source, Telerik.Web.UI.GridUpdatedEventArgs e)
        {
            ...
            String id = item.GetDataKeyValue("SpecializationID").ToString();
        ...
        protected void RadGrid1_ItemDeleted(object source, GridDeletedEventArgs e)
        {
            ...
            String id = dataItem.GetDataKeyValue("SpecializationID").ToString();
