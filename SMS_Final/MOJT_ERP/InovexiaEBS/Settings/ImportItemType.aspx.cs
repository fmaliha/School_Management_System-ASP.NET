...
{
    public partial class ImportItemType : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_ItemUpdated(object source, Telerik.Web.UI.GridUpdatedEventArgs e)
        {
            ...
            String id = item.GetDataKeyValue("ImportItemTypeID").ToString();
        ...
        protected void RadGrid1_ItemDeleted(object source, GridDeletedEventArgs e)
        {
            ...
            String id = dataItem.GetDataKeyValue("ImportItemTypeID").ToString();
