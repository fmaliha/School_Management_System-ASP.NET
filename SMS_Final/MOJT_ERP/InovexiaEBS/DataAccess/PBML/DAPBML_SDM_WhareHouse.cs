...
{
    public class DAPBML_SDM_WhareHouse
    {
        PBSDBUtility idbutility = new PBSDBUtility();
        public long InsertPBML_SDM_WhareHouse(BOPBML_SDM_WhareHouse boItem)
        {
            ...
            try
            {
                ...
                ht.Add("WhareouseName", boItem.WhareouseName1);
                ...
                return Convert.ToInt64(idbutility.InsertData(ht, "spInsertPBML_SDM_WhareHouse"));
            }
            catch (Exception ex)
            {
                throw ex;
